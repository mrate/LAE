...
Vector operator*( int c, const Vector& w ) {
	Vector v;
	v.x = c * w.x;
	v.y = c * w.y;
	v.z = c * w.z;
...
Vector operator*( const Vector& w, int c ) {
	Vector v;
	v.x = c * w.x;
	v.y = c * w.y;
	v.z = c * w.z;
...
Vector operator*( const Vector& w, double c ) {
	Vector v;
	v.x = c * w.x;
	v.y = c * w.y;
	v.z = c * w.z;
...
Vector sum( int n, int c[], const Vector w[] ) {     // vector sum
	int     maxd = 0;
	Vector  v;
...
Vector sum( int n, double c[], const Vector w[] ) {  // vector sum
	int     maxd = 0;
	Vector  v;
